...
def load_tasks():
    """Load tasks from file, or return an empty list if file does not exist."""
    if not os.path.exists(TODO_FILE):  # Fix: Check if file does not exist
        return []
...
if __name__ == "__main__":  # Fix: Corrected name check
    cli()
